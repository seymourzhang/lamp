...
import com.on.wechat.wxpay.sdk.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        if (SignType.MD5.equals(this.signType)) {
            ...
            temp.put("mch_id", config.getMchID());
            temp.put("nonce_str", WXPayUtil.generateNonceStr());
            String signKey = WXPayUtil.generateSignature(temp, config.getKey(), this.signType);
            temp.put("sign", signKey);
            System.out.println("canshu:" + reqData);
            String url = WXPayConstants.SANDBOX_GETSIGNKEY;
            String respXml = this.requestWithoutCert(url, temp, 8000, 10000);
            System.out.println("signKey:" + respXml);
            key = WXPayUtil.xmlToMap(respXml).get("sandbox_signkey");
//            this.config.setKey(key);
        ...
        System.out.println("all Params:" + reqData);
        return reqData;
    }
