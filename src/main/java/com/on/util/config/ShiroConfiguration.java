package com.on.util.config;

import com.on.filter.ShiroRealmPersonal;
...
/**
 * shiro配置类
 * Created by seymour on 2018/04/22.
 */
@Configuration
public class ShiroConfiguration {
    ...
    public ShiroRealmPersonal shiroRealm() {
        ShiroRealmPersonal realm = new ShiroRealmPersonal();
